...
> **تحديث (2026-06-18):** اعتُمدت **قرارات schema v1** (حساب الطفل، من يُنشئ الأطفال،
> الحلقات، موافقة ولي الأمر، احتفاظ التسجيلات، الضيف، الإشعارات، تعديل النقاط،
> الحذف، اتجاه Supabase) وأُغلقت معظم الأسئلة المفتوحة. التفاصيل في
> `docs/PRODUCTION_DATA_MODEL_SCHEMA.md` → قسم «Approved Schema Decisions v1».
> أول تنفيذ مُحدّد في `docs/AUTH_PROFILES_PHASE2_SCOPE.md` (Auth/Profiles فقط).
