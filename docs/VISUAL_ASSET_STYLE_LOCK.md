...
## E1. Front-Facing Rule (إلزامي لكل أصل)

> كل أصل يُستخدم داخل الواجهة بأحجام صغيرة، فيجب أن يُقرأ خلال ثانيتين →
> **مواجِه للكاميرا مباشرة، مركزي، متماثل قدر الإمكان.**

- ✅ front-facing · centered · symmetrical if possible · clear silhouette ·
  وضعية هادئة وواضحة.
- ❌ side view · extreme/dramatic angle · dramatic perspective · rotated object ·
  ميلان زائد · 3/4 view (يُتجنّب، ولا يُسمح إلا عند ضرورة قصوى).
- **الشخصيات:** الوجه والجسم باتجاه الكاميرا، تنظر **للأمام مباشرة**، بلا التفات
  جانبي ولا pose معقدة.
- **الأيقونات/الأوسمة:** العنصر الأساسي مواجِه ومركزي، بلا زاوية جانبية أو منظور
  حاد يُضعف الوضوح.
...
| نجاح / تشجيع / علامة صح | **ذهبي `#F6C65B` أو كريمي `#FFF8EA`** | ⛔ **مُنع الأخضر التركوازي/المنت** في الأصول (غير مرغوب) |
...
**ملاحظة لون النجاح:** رغم أن `--color-success-mint` موجود في التوكنز للاستخدام
في الواجهة، **لا يُستخدم اللون التركوازي/المنت داخل الأصول المولّدة** (طلب صريح:
غير جميل). تُعبَّر علامات الصح/الموافقة بالذهبي أو الكريمي على خلفية بنفسجية.

**2) البشر ولون البشرة (color realism):** أي شخصية بشرية (طفل/معلم/ولي أمر):
- **لون البشرة طبيعي بشري** (درجات بيج/سمرة واقعية متنوّعة، قريبة من بشرة أهل
  حضرموت/اليمن).
- ❌ لا بشرة بنفسجية، ولا بشرة مصبوغة بألوان الهوية.
- ألوان الهوية تذهب إلى **الخلفية والعناصر المساندة**، أما الزي فتقليدي (انظر
  الأزياء أدناه). الشعر/العيون بألوان طبيعية.

**2b) أزياء الشخصيات — طراز حضرمي يمني (مرجع المستخدم):**
- **المعلم (رجل):** عالِم/مدرّس بزي حضرمي — **ثوب أبيض + عمامة بيضاء (إمامة) أو
  كوفية بيضاء** + لحية قصيرة مهذّبة، وقور ولطيف. (لا عمامة خضراء/تركوازية.)
- **المعلمة (امرأة):** فتاة/امرأة **بحجاب** محتشم وهادئ.
- **الأولاد (بنين):** **ثوب أبيض + كوفية/طاقية** (كما في صورة المجموعة المرفقة).
- **البنات:** **حجاب** مثل المعلمة.
- البشرة طبيعية؛ الزي أبيض تقليدي؛ لمسة الهوية البنفسجية تأتي من الخلفية/الإطار
  عند الاستخدام داخل التطبيق، لا من صبغ الزي أو الجلد.
- (يُلغى ماسكوت شبل الطفل لصالح طفل بشري بالزي الحضرمي.)

**3) عام:** لا ألوان خارج الـ palette المقصودة (عدا لون البشرة الطبيعي والأبيض
الصريح للزي). الذهبي للإنجاز/النجاح، الكورال للتنبيه/العاطفة. **ممنوع التركوازي/المنت
في الأصول.**
