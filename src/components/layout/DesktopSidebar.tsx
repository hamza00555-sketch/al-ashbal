  ...
  return (
    <aside
      ...
      className={cn(
        ...
        "hidden w-64 shrink-0 flex-col gap-lg border-s border-white/10 bg-surface p-lg md:flex",
        className,
      )}
    >
      {header}
      <nav className="flex flex-col gap-2xs">
        {items.map((item) => {
          ...
          const itemClass = cn(
            "flex items-center gap-sm rounded-md px-md py-sm text-button transition",
            active
